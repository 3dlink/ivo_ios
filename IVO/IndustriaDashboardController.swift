//
//  IndustriaDashboardController.swift
//  IVO
//
...
class IndustriaDashboardController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
